...
def get_cropped_image(image_path, image_base64_data):
    f_cascade = cv2.CascadeClassifier('./opencv/haarcascades/haarcascade_frontalface_default.xml')
    e_cascade = cv2.CascadeClassifier('./opencv/haarcascades/haarcascade_eye.xml')
